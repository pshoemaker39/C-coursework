...
public:
  ...
  StringNode(const std::string &newString) : Node(),
                                             value_(newString)
  {
  }

  //  PURPOSE:  To make '*this' a copy of 'rhs'.  No return value.
  StringNode(const StringNode &rhs) : Node(*this),
                                      value_(rhs.value_)
  {
  }
...
public:
  ...
  //  PURPOSE:  To
  InputCharStream(std::string &newInput) : input_(newInput),
                                           index_(0)
  {
  }
...
public:
  ...
  //	value.
  Symbol(symbol_t newSymbol) : symbol_(newSymbol),
                               stringPtr_(NULL),
                               integer_(0)
  {
  }
  ...
  //	value.
  Symbol(const std::string &newString) : symbol_(STRING_CONST_SYM),
  ...
  //	value.
  Symbol(unsigned int newInteger) : symbol_(INTEGER_CONST_SYM),
                                    integer_(newInteger),
                                    stringPtr_(NULL)
  {
  }
...
public:
  ...
  TokenStream(InputCharStream &newInputCharStream) throw(const char *) : inputCharStream_(newInputCharStream),
                                                                         lastParsedPtr_(NULL)
  {
    advance();
  }
